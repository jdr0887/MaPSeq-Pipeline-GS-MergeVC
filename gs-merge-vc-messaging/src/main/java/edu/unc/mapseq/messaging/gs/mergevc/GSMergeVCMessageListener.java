...
public class GSMergeVCMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(GSMergeVCMessageListener.class);

    public GSMergeVCMessageListener() {
        super();
    }
