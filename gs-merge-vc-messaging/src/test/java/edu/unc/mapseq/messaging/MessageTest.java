    ...
    public void testQueue() {
        ...
        try {
            ...
            try {
                ...
                generator.writeStringField("upstreamWorkflowRunId", "2544138");

                generator.writeArrayFieldStart("attributes");

                generator.writeStartObject();
                generator.writeStringField("name", "subjectName");
                generator.writeStringField("value", "084108Sm");
                ...
                generator.writeStringField("name", "jdr-gs-vc-test-084108Sm");
                generator.writeEndObject();
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                producer.send(session.createTextMessage(
                        String.format(format, line.trim(), "jdr-test-gs-variant-calling", DateFormatUtils.ISO_TIME_NO_T_FORMAT.format(new Date()))));
                try {
                    Thread.sleep(1000);
