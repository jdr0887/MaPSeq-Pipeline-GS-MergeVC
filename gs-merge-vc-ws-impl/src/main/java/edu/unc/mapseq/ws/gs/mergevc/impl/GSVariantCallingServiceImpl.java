package edu.unc.mapseq.ws.gs.mergevc.impl;
...
import edu.unc.mapseq.ws.gs.mergevc.MetricsResult;

public class GSVariantCallingServiceImpl implements GSMergeVCService {

    private static final Logger logger = LoggerFactory.getLogger(GSVariantCallingServiceImpl.class);
    ...
    public GSVariantCallingServiceImpl() {
        super();
    }
